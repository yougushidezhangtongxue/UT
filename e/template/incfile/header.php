...
<style>
body {
background:#EFEFEF/*<?=$bgcolor?> url(<?=$Diybg?>) <?=$Bgalign?> top <?=$repeatBg?><?=$lockbg?>*/;
<?=$bgsize?>
}
</style>
</head>
...
<div class="hysidebar">
  <div class="userbox yh">
    <div class="avator"> <a href="#" class="avatorpic"><img src="<?=$userpic?>" /></a> <a href="<?=$public_r['newsurl']?>e/member/EditUserPic/" class="editavator">修改头像</a> </div>
    <div class="userxx yh">
      <h4>
        <?=$tmgetusername?>
      </h4>
