...
function page1($num,$line,$page_line,$start,$page,$search){
	...
	$firststr='<li class="prev-page"><a title="'.$fun_r['trecord'].'">&nbsp;<b>'.$num.'</b> </a></li>';
	//上一页
	if($page<>0)
	{
		$toppage='<li class="prev-page"><a href="'.$url.'=0'.$search.'">'.$fun_r['startpage'].'</a></li>';
		$pagepr=$page-1;
		$prepage='<li class="prev-page"><a href="'.$url.'='.$pagepr.$search.'">'.$fun_r['pripage'].'</a></li>';
	}
	//下一页
	if($page!=$totalpage-1)
	{
		$pagenex=$page+1;
		$nextpage='<li class="next-page"><a href="'.$url.'='.$pagenex.$search.'">'.$fun_r['nextpage'].'</a></li>';
		$lastpage='<li class="next-page"><a href="'.$url.'='.($totalpage-1).$search.'">'.$fun_r['lastpage'].'</a></li>';
	}
