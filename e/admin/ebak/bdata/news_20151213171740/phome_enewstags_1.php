...
E_D("replace into `phome_enewstags` values('4','太酷啦','1','0','0');");
E_D("replace into `phome_enewstags` values('5','用线','4','0','0');");
E_D("replace into `phome_enewstags` values('6','史瑞克','4','0','0');");
E_D("replace into `phome_enewstags` values('7','现实中','4','0','0');");
...
E_D("replace into `phome_enewstags` values('19','告诉你','1','0','0');");
...
E_D("replace into `phome_enewstags` values('25','要不要','2','0','0');");
E_D("replace into `phome_enewstags` values('26','更具','2','0','0');");
E_D("replace into `phome_enewstags` values('27','更美好','2','0','0');");
...
E_D("replace into `phome_enewstags` values('31','小工具','2','0','0');");
...
E_D("replace into `phome_enewstags` values('35','你也来','2','0','0');");
E_D("replace into `phome_enewstags` values('36','拼出','4','0','0');");
E_D("replace into `phome_enewstags` values('37','用食材','4','0','0');");
...
E_D("replace into `phome_enewstags` values('41','没吃过','2','0','0');");
E_D("replace into `phome_enewstags` values('42','将食材','2','0','0');");
E_D("replace into `phome_enewstags` values('43','舍得吃','2','0','0');");
E_D("replace into `phome_enewstags` values('44','又可','4','0','0');");
E_D("replace into `phome_enewstags` values('45','超可爱','2','0','0');");
E_D("replace into `phome_enewstags` values('46','猫肉球','2','0','0');");
E_D("replace into `phome_enewstags` values('47','既可','2','0','0');");
E_D("replace into `phome_enewstags` values('48','世界上最小','2','0','0');");
E_D("replace into `phome_enewstags` values('49','在空中','2','0','0');");
...
E_D("replace into `phome_enewstags` values('59','多功能','2','0','0');");
...
E_D("replace into `phome_enewstags` values('67','净化空气','2','0','0');");
E_D("replace into `phome_enewstags` values('68','EVE','2','0','0');");
E_D("replace into `phome_enewstags` values('69','离线','2','0','0');");
E_D("replace into `phome_enewstags` values('70','更强大','2','0','0');");
E_D("replace into `phome_enewstags` values('71','无障碍','2','0','0');");
E_D("replace into `phome_enewstags` values('72','SIGMO','2','0','0');");
E_D("replace into `phome_enewstags` values('73','360','2','0','0');");
E_D("replace into `phome_enewstags` values('74','近距离','2','0','0');");
E_D("replace into `phome_enewstags` values('75','世界上','4','0','0');");
E_D("replace into `phome_enewstags` values('76','被遗忘','2','0','0');");
...
E_D("replace into `phome_enewstags` values('89','绘画作品','3','0','0');");
E_D("replace into `phome_enewstags` values('90','手工制作','3','0','0');");
E_D("replace into `phome_enewstags` values('91','大家都','3','0','0');");
E_D("replace into `phome_enewstags` values('92','味儿','3','0','0');");
E_D("replace into `phome_enewstags` values('93','唇上','3','0','0');");
E_D("replace into `phome_enewstags` values('94','唇妆有','3','0','0');");
...
E_D("replace into `phome_enewstags` values('98','丛林里','1','0','0');");
