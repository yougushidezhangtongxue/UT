...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<div align="left">
		&raquo;&nbsp;<font color=red><b><?=$myusername?></b></font>&nbsp;&nbsp;<a href="../my/" target="_parent"><?=$groupname?></a>&nbsp;<?=$havemsg?>&nbsp;<a href="/e/space/?userid=<?=$myuserid?>" target=_blank>æˆ‘çš„ç©ºé—´</a>&nbsp;&nbsp;<a href="../msg/" target=_blank>çŸ­ä¿¡æ¯</a>&nbsp;&nbsp;<a href="../fava/" target=_blank>æ”¶è—å¤¹</a>&nbsp;&nbsp;<a href="../cp/" target="_parent">æ§åˆ¶é¢æ¿</a>&nbsp;&nbsp;<a href="../../member/doaction.php?enews=exit&prtype=9" onclick="return confirm('ç¡®è®¤è¦é€€å‡º?');">é€€å‡º</a> 
	</div>
	</td>
    </tr>
</table>
