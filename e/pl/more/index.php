...
?>
document.write(" <li class=\"comment even thread-even depth-1\" id=\"comment-<?=$r[plid]?>\">            <div class=\"c-avatar\"><img alt=\'\' data-original=\'/skin/ecms009/images/default.png\' class=\'avatar avatar-50 photo\' height=\'50\' width=\'50\' /></div>            <div class=\"c-main\" id=\"div-comment-<?=$r[plid]?>\"><span class=\"c-author\"><a href=\'/e/space/?userid=<?=$r[userid]?>\' rel=\'external nofollow\' class=\'url\'><?=$plusername?></a></span><?=$saytext?>              <time class=\"c-time\"><?=$saytime?></time>              <a class=\'comment-reply-link\' href=\'#tosaypl\' onclick=\'return addComment.moveForm(\"div-comment-<?=$r[plid]?>\", \"<?=$r[plid]?>\", \"respond\", \"<?=$r[plid]?>\")\' >回复</a></div>          </li>");
<?php
}
?>
document.write("");
