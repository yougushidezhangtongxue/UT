...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="25">选择/上传附件:
      ...
      <input type="button" name="Submit" value="选择" onclick="window.open('ecmseditor/FileMain.php?<?=$ecms_hashur[ehref]?>&type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=changedown_url','','width=700,height=550,scrollbars=yes');">&nbsp;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td height="25">选择/上传附件: 
      <input name="changeonline_url" id="changeonline_url" type="text" size="32"> <input type="button" name="Submit" value="选择" onclick="window.open('ecmseditor/FileMain.php?<?=$ecms_hashur[ehref]?>&type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=changeonline_url','','width=700,height=550,scrollbars=yes');">&nbsp;
