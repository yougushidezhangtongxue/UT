...
<script>window._deel = {name: '<?=$public_r[sitename]?>',url: '[!--news.url--]', ajaxpager: 'on', commenton: 0, roll: [1,8],appkey: {tqq: '123456',tsina: '123456'}}
</script>
  ...
  <div class="content-wrap">
    <div class="content">
      <header class="archive-header">
        <h1><i class="fa fa-folder-open"></i> &nbsp;关键词：[!--keyboard--]</h1>
      </header>
...
<footer class="footer">
  <div class="footer-inner">
    <div class="copyright pull-left"> <a href="[!--news.url--]" title="<?=$public_r[sitename]?>"><?=$public_r[sitename]?></a> 吾爱源码BBS.52CODES.NET版权所有，保留一切权利 ! Theme <a href="http://www.moyublog.com">Moyu</a> © 2011-2014 · <?=$public_r['add_icp']?> </div>
